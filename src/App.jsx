            ...
            <div className="flex-grow-1 p-4 bg-light">
                ...
                <Routes>
                    ...
                    <Route
                        ...
                        element={<RestaurantTableDetails />}
                    />

                    <Route
                        path="/book-table/:tableId"
                        element={<BookRestaurantTable />}
                    />
                    ...
                    <Route
                        path="/food-order/:foodOrderId"
                        element={<FoodOrder />}
                    />

                    <Route
                        path="/food-order-test"
                        element={<FoodOrder />}
                    />
